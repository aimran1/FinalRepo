...
class Screen{
 ...
 Screen(boolean f){ 
  ...
  elements[5] = new Location(417.0,667.0,-112.0,-163.0,' ');
  elements[6] = new Location(87.0,772.0,227.0,98.0,' '); 
  elements[7] = new Location(474.0,223.0,17.0,-56.0,' '); 
  elements[8] = new Location(483.0,166.0,232.0,-78.0,' '); 
  elements[9] = new Location(705.0,166.0,18.0,57.0,' '); 
  elements[10] = new Location(703.0,223.0,100.0,157.0,' ')
;
  enemies=new Enemy[2];
  enemies[0] = new Enemy();
